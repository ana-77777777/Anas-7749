...
object PdfExportHelper {
    ...
    fun generateAccountStatementPdf(
        ...
        // Draw Custom Logo Emoji/Symbol if enabled
        ...
        val f = File(context.cacheDir, "Statement_${accountName.replace(" ", "_")}.pdf")
        try {
    ...
    fun sharePdf(context: Context, pdfFile: File) {
        ...
        context.startActivity(Intent.createChooser(intent, "مشاركة كشف الحساب كـ PDF"))
    }
}
